          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" >
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Archived Assets</h1>
              </div>
              <div class="column">
                <div class="field">
            ...
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="assets.php" class="button is-white" type="button" name="button" id="addbtn">
                    <i class="fas fa-car-side"></i>&nbsp; View All Assets
                  </a>
                </p>
              </div>
            </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-success m-1" title="restore asset"  href="archiveasset.php?asset_id=<?php echo $row['asset_id']; ?>">
