...
if(isset($_GET['page'])){
  ...
  $query = "SELECT * FROM facility_status
            ...
            ORDER BY facility_status.date DESC, branch
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            ...
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  ...
                  &nbsp;&nbsp;
                  <a class="is-active">Facility Status</a>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="column is-full">
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                $pr_query = "SELECT * FROM facility_status
                            INNER JOIN facility ON facility.facility_id = facility_status.facility_id
                            ORDER BY facility_status.date DESC, branch";
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='facilitystatus.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='facilitystatus.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href=facilitystatus.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
