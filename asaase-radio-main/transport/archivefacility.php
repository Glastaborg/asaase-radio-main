            ...
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="facility.php" class="button is-white" type="button" name="button" id="addbtn">
                    <i class="fas fa-building"></i>&nbsp; View Archived Data
                  </a>
                </p>
              </div>
            </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-success m-1" title="restore facility"  href="archivefacility.php?facility_id=<?php echo $row['facility_id']; ?>">
