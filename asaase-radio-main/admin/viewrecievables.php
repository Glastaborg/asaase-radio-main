...
if(isset($_GET['pay_rec_id'])){
  ...
  $query = "SELECT * FROM pay_rec
            WHERE pay_rec.pay_rec_id = '$pay_rec_id'";
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li><a href="recievables.php" aria-current="page">Recievables Reports</a></li>
            <li class="is-active"><a href="#" aria-current="page">View Recievable Report</a></li>
          </ul>
        </nav>
            ...
            <div class="columns">
              <div class="column is-half">
                <p class="has-text-left">
                  <a href="editrecievables.php?pay_rec_id=<?php echo $row['pay_rec_id']; ?>" class="button is-info mb-2">Edit Recievable Details</a>
                </p>
              </div>
              <div class="column is-half">
          ...
          <div class="column is-full" id="report">
            <div class="columns is-multiline">
              <div class="column is-full">
                ...
                <h2 class="title is-size-4 has-text-centered">RECIEVABLE DETAILS</h2>
                  ...
                  <table class="table is-fullwidth is-striped is-bordered is-narrow is-hoverable" id="table">
                    <thead>
                      <tr>
                        ...
                        <th class="is-size-6 is-size-7-mobile">Amount (GHS)</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td class="is-size-6 is-size-7-mobile pb-5" style="width:60%"><?php echo $row['desciption']; ?></td>
                        <td class="is-size-6 is-size-7-mobile pb-5"><?php echo $row['amount']; ?></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
