    ...
    <div class="column is-10 has-background-light" id="main">
      ...
      <nav class="breadcrumb p-3" aria-label="breadcrumbs">
        <ul>
          ...
          <li><a href="subleavereq.php" aria-current="page">Employee Leave</a></li>
              ...
              <div class="column is-half">
                ...
                <div class="field">
                  ...
                  <div class="control">
                    ...
                    <input type="text" class="input has-background-light" name="selected_reason" value="<?php echo $data['reason']; ?>" readonly>
                  </div>
                  <div class="field">
