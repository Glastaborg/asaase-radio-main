...
if(isset($_GET['neg_fed_id'])){
  ...
  $query = "SELECT * FROM negative_fed
            WHERE negative_fed.neg_fed_id = '$neg_fed_id'";
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">View Negative Feedback</a></li>
          </ul>
        </nav>
            ...
            <div class="columns">
              <div class="column is-half">
                <p class="has-text-left">
                  <a href="editnegative.php?neg_fed_id=<?php echo $row['neg_fed_id']; ?>" class="button is-info mb-2">Edit Negative Feedback Details</a>
                </p>
              </div>
              <div class="column is-half">
          ...
          <div class="column is-full" id="report">
            <div class="columns is-multiline">
              <div class="column is-full">
                ...
                <h2 class="title is-size-4 has-text-centered">NEGATIVE FEEDBACK DETAILS</h2>
