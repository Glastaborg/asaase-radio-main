...
include('assets/delete.php');
  ...
  $query = "SELECT * FROM employee_works
            ...
            WHERE employee_works.archived = 'No' AND employee_works.branch = '$sessbranch'
            ";
          ...
          <div class="column is-full is-align-items-center">
            ...
            <div class="table-container">
              <table class="table is-fullwidth is-striped is-narrow is-hoverable" id="table">
                ...
                <thead>
                  <tr >
                    <th class="is-size-6 is-size-7-mobile">File ID</th>
                  ...
                  <tr class="datatr" >
                    ...
                    <td class="is-size-6 is-size-7-mobile has-text-right pr-6">
                     ...
                     ?>
                      ...
                      <a class="button is-size-7 is-danger m-1" title="delete"  href="employeesworks.php?file_id=<?php echo $row['id']; ?>">
