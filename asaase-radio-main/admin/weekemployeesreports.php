...
if(isset($_GET['page'])){
  ...
  $query = "SELECT * FROM employee_report
            ...
            WHERE employee_report.date > NOW() - INTERVAL 1 WEEK
            ORDER BY date DESC
    ...
    <div class="columns">
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            ...
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  ...
                  &nbsp;&nbsp;
                  <a class="is-active">This Week Reports</a>
                </p>
              </div>
            </div>
          </div>
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" style="border-bottom: 1px solid #c7c7c7;">
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">This Week Employees Reports</h1>
              </div>
              <div class="column">
                <div class="field">
          ...
          <div class="column is-full">
            <a href="addemployees.php" class="button is-info " type="button" name="button" id="addbtn">Add Employee Report</a>
          </div>
              ...
              <table class="table is-fullwidth is-striped is-narrow is-hoverable" id="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile"><?php echo $row['activity_description']; ?></td>
                    <td class="is-size-6 is-size-7-mobile">
                      ...
                      <a class="button is-size-7 is-info m-1" title="update employeesreports"  href="editemployeesreport.php?employee_report_id=<?php echo $row['employee_report_id']; ?>">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a class="button is-size-7 is-danger m-1" title="delete employeesreports"  href="delete.php?employee_report_id=<?php echo $row['employee_report_id']; ?>">
          ...
          <div class="column is-full">
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='employeesreports.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='employeesreports.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href='employeesreports.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
