        ...
        <div class="section has-background-light ">
            <div class="columns is-multiline has-background-light ">
                <div class="column has-background-light is-12 py-3">
                    ...
                    <br>    
                    <h2 class="title is-size-1 is-size-3-mobile px-3 has-text-centered has-text-brown">Asaase Radio Job Vacancies</h2>
                </div>
                <?php
                ...
                <div class="column is-full">
                    <div class="card mt-2 p-1">
                        <div class="card-content">
                            <p class="subtitle has-text-left is-size-3 is-size-4-mobile"> <strong>Job Title: </strong>  <?php echo $row['vacancy_title']; ?></p>
                            ...
                            <div class="content has-text-right">
                                <a href="viewvacancy.php?vacancy_id=<?php echo $row['vacancy_id']; ?>"  class="button has-background-info has-text-white p-3"> Read More</a>
                            </div>
                        </div>
                    </div>
                </div>
