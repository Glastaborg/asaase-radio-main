                ...
                ?>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <?php $postions = ['Head of Technical', 'Sales Manager', 'Head of Finance', 'Executive Assistant']; ?>
                      <?php if ($row['leave_status'] == 'Pending' and in_array($row['job_description'], $postions)) {
