...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Admin Add Asset Status </title>
    <!-- CSS Links-->
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">Add Asset Status</a></li>
          </ul>
        </nav>
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            <div class="column is-full" style="border-bottom: 1px solid #c7c7c7;">
              <h1 class="title is-size-5">Add Asset Status</h1>
            </div>
              ...
              <form class="columns is-multiline" action="addassetstatus.php" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <textarea class="textarea" name="description" rows="3" placeholder="Enter Asset Status Description" required></textarea>
                    </div>
                  </div>
                  <div class="field">
