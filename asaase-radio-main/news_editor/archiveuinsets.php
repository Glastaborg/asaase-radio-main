          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" >
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Archived Unplayed Insets Reports</h1>
              </div>
              <div class="column">
                <div class="field">
            ...
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="uinsets.php" class="button is-white" type="button" name="button" id="addbtn">
                    <i class="fas fa-video-slash"></i>&nbsp; View Unplayed Insets
                  </a>
                </p>
              </div>
            </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-success m-1" title="restore unplayed insets"  href="archiveuinsets.php?insets_id=<?php echo $row['insets_id']; ?>">
