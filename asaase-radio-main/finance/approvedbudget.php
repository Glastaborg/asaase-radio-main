            ...
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  ...
                  &nbsp;&nbsp;
                  <a class="is-active">Approved Budget</a>
                  &nbsp;&nbsp;
          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" >
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Approved Activity Budget</h1>
              </div>
              <div class="column">
                <div class="field">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <?php if ($row['budget_status'] == 'Pending') { ?>
                      ...
                      <?php } ?>
                      <?php if ($row['budget_status'] == 'Approved') { ?>
