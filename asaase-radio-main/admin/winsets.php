...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Admin Wrong Insets </title>
    <!-- CSS Links-->
          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" >
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Wrong Insets Reports</h1>
              </div>
              <div class="column">
                <div class="field">
            ...
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  ...
                  &nbsp;&nbsp;
                  <a class="is-active">Wrong Insets</a>
                  &nbsp;&nbsp;
          ...
          <div class="column is-full">
            <div class="columns">
              <div class="column is-half">
                <a href="addwinsets.php" class="button is-info " type="button" name="button" id="addbtn">Add Wrong Insets</a>
              </div>
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="genwinsets.php" class="button is-white" type="button" name="button" id="addbtn">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-info m-1" title="view wrong insets"  href="viewwinsets.php?insets_id=<?php echo $row['insets_id']; ?>">
                        <i class="fas fa-eye"></i>
                      </a>
                      <a class="button is-size-7 is-info m-1" title="update wrong insets"  href="editwinsets.php?insets_id=<?php echo $row['insets_id']; ?>">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a class="button is-size-7 is-danger m-1" title="delete wrong insets"  href="winsets.php?insets_id=<?php echo $row['insets_id']; ?>">
          ...
          <div class="column is-full">
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='winsets.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='winsets.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href=winsets.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
