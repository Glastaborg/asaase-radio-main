...
include('assets/restore.php');
  ...
  $query = "SELECT * FROM activities
            ...
            WHERE branch <> 'Admin'
            AND archive_act = 'No' AND archive_activity_budget = 'Yes'
          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1">
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Archive Activity Budget</h1>
              </div>
              <div class="column">
                <div class="field">
            ...
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="activitybudget.php" class="button is-white" type="button" name="button" id="addbtn">
                    <i class="fas fa-money-bill-wave"></i>&nbsp; All Activity Budget
                  </a>
                </p>
              </div>
            </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      ...
                      <a class="button is-size-7 is-success m-1" title="restore event"  href="archiveactivitybudget.php?activity_budget_id=<?php echo $row['activity_budget_id']; ?>">
