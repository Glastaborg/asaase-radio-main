            ...
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  ...
                  &nbsp;&nbsp;
                  <a href="ksiempreports.php">Kumasi Weekly Reports</a>
                  &nbsp;&nbsp;
                  <a class="is-active">Tamale Weekly Reports</a>
                </p>
              </div>
            </div>
          </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      ...
                      <a class="button is-size-7 is-danger m-1" title="delete employeesreports"  href="tamaleempreports.php?employee_report_id=<?php echo $row['employee_report_id']; ?>">
            ...
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                $pr_query = "SELECT * FROM employee_report
                             ...
                             INNER JOIN activities ON activities.activity_id = employee_report.activity_id
                             WHERE employee.branch = 'Tamale'
                             ORDER BY date DESC, activities.activity_id";
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='tamaleempreports.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='tamaleempreports.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href='tamaleempreports.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
