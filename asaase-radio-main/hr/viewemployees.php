            ...
            <div class="columns">
              <div class="column is-half">
                <p class="has-text-left">
                  <a href="editemployees.php?employee_id=<?php echo $row['employee_id']; ?>" class="button is-info " type="button" name="button" id="addbtn">Edit Employee</a>
                </p>
              </div>
              <div class="column is-half">
                      ...
                      <?php
                        ...
                        if (mysqli_num_rows($imageresult) > 0 ) {
                          ...
                          echo '<tr>
                                  <td colspan="3">
                                    <figure>
                                      <img src="employee_images/'.$emp_pic.'" style="width:180px; height:240px;" alt="Employee Picture">
                                    </figure>
                                  </td>
                                </tr>';
                        }
