...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Admin Add Team Members </title>
    <!-- CSS Links-->
            ...
            <div class="column is-full">
              <form class="columns is-multiline" action="editteams.php?activity_id=<?php echo $activity_id; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="column is-half">
                  ...
                  <tbody>
                    <?php
                      $dataquery = "SELECT * FROM teammembers
                    ...
                    <tr>
                      <td class="is-size-6 is-size-7-mobile">
                        <?php echo $data['firstname']; ?> <?php echo $data['lastname']; ?> - <?php echo $data['member_type']; ?>
                      </td>
                      <td class="is-size-6 is-size-7-mobile">
                        <a class="button is-size-7 is-danger m-1" title="delete teammember"  href="editateams.php?team_id=<?php echo $data['id']; ?>">
