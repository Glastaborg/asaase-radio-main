...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Admin Ongoing Activities </title>
    <!-- CSS Links-->
            ...
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  ...
                  &nbsp;&nbsp;
                  <a class="is-active">Ongoing Activities</a>
                  &nbsp;&nbsp;
          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" style="border-bottom: 1px solid #c7c7c7;">
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Ongoing Activities</h1>
              </div>
              <div class="column">
                <div class="field">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      ...
                      <a class="button is-size-7 is-danger m-1" title="delete event"  href="ongoingactivities.php?activity_id=<?php echo $row['activity_id']; ?>">
          ...
          <div class="column is-full">
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='ongoingactivities.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='ongoingactivities.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href='ongoingactivities.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
