...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Department Head Generate Report Employees </title>
    <!-- CSS Links-->
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li><a href="leave.php">Employees Leave</a></li>
            <li class="is-active"><a href="#" aria-current="page">Generate Report</a></li>
          </ul>
        </nav>
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">

          <form class="column is-half" action="genleave.php" method="post">
            <h1 class="title is-size-5">Generate Employees Leave Report</h1>
            <div class="field">
            ...
            <div class="field is-grouped my-5">
              <p class="control  is-size-6">
                <button class="button is-info" name="genleave">
                  &nbsp; Generate &nbsp;
                </button>
              </p>
