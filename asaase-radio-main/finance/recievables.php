        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
              ...
              <div class="column is-half">
                <form class="" action="" method="post" enctype="multipart/form-data">
                  <div class="field is-grouped my-5">
                    ...
                    <div class="control">
                      <button class="button is-info" type="submit" name="import_rec">
                        &nbsp; Import &nbsp;
                      </button>
                    </div>
                  </div>
          ...
          <div class="column is-full">
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="archiverec.php" class="button is-white" type="button" name="button" id="addbtn">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-success m-1" title="view week recievable"  href="viewrecievables.php?pay_rec_id=<?php echo $row['pay_rec_id']; ?>">
