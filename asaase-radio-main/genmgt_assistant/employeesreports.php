...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || General Manager Employees Report </title>
    <!-- CSS Links-->
              ...
              <table class="table is-fullwidth is-striped is-narrow is-hoverable" id="table">
                <thead>
                  <tr>
                    ...
                    <th class="is-size-6 is-size-7-mobile">Comments</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      ...
                      <a class="button is-size-7 is-success m-1" title="comment"  href="editempreport.php?employee_report_id=<?php echo $row['employee_report_id']; ?>">
