...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Admin Completed Activities </title>
    <!-- CSS Links-->
    ...
    <div class="columns">
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" style="border-bottom: 1px solid #c7c7c7;">
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Completed Activities</h1>
              </div>
              <div class="column">
                <div class="field">
          ...
          <div class="column is-full">
            <a href="addactivity.php" class="button is-info " type="button" name="button" id="addbtn">Add Activity</a>
          </div>
              ...
              <table class="table is-fullwidth is-striped is-narrow is-hoverable" id="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile"><?php echo $row['end_date']; ?></td>
                    <td class="is-size-6 is-size-7-mobile"><?php echo $row['observation']; ?></td>
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-info m-1" title="view event"  href="viewactivities.php?activity_id=<?php echo $row['activity_id']; ?>">
                      ...
                      <a class="button is-size-7 is-danger m-1" title="delete event"  href="completedactivities.php?activity_id=<?php echo $row['activity_id']; ?>">
          ...
          <div class="column is-full">
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                $pr_query = "SELECT activities.* FROM activities
                             WHERE activities.activity_status = 'Completed'
                             ORDER BY activity_date DESC, branch";
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='completedactivities.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='completedactivities.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href='completedactivities.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
