...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Employee Profile </title>
    <!-- CSS Links-->
              ...
              <div class="columns is-multiline" >
                <form class="column is-half" action="profile.php" method="post" enctype="multipart/form-data">
                  ...
                  <div class="field">
                   ...
                   <?php
                        if ($_SESSION['job_description'] === "Sales" || $_SESSION['department'] === "Sales") {
                      ?>
                         <div class="field">
                          <label class="label">Google Drive Link <span class="has-text-danger"></span></label>
                          <div class="control">
                            <input class="input" name="link_url"  value="<?php echo $row['link_url']; ?>" >
                          </div>
                        </div>
                    <?php }?>
