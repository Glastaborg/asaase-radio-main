...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Department Head Edit Negative Feedback </title>
    <!-- CSS Links-->
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">Edit Negative Feedback</a></li>
          </ul>
        </nav>
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            <div class="column is-full" style="border-bottom: 1px solid #c7c7c7;">
              <h1 class="title is-size-5">Edit Negative Feedback</h1>
            </div>

            <div class="column is-full">
              <?php
                $neg_fed_id = $_GET['neg_fed_id'];
                $dataquery = "SELECT * FROM negative_fed WHERE neg_fed_id ='$neg_fed_id'";
                $dataresult = mysqli_query($dbcon, $dataquery);
                if (mysqli_num_rows($dataresult) > 0) {
                  $data = mysqli_fetch_array($dataresult);

              ?>
              <form class="columns is-multiline" action="editnegative.php?neg_fed_id=<?php echo $neg_fed_id; ?>" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  ...
                  <div class="field">
                    <input type="text" name="neg_fed_id" value="<?php echo $data['neg_fed_id']; ?>" hidden required>
                  ...
                  <div class="field is-grouped my-5">
                    ...
                    <p class="control">
                      <button class="button is-info" name="updatenegative">
                        &nbsp; Update &nbsp;
                      </button>
                    </p>
                  </div>
