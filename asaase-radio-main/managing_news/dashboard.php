      ...
      <div class="columns p-3">
        <div class="column">
          <div class="card is-info">
            ...
            -- OR employee.position = 'Head of Online'
                  OR employee.job_description = 'Head of Sports'
            OR employee.job_description = 'Head of Social Media'
             OR employee.job_description = 'Head of Technical'
            -- OR employee.job_description = 'Programs Manager' 
            OR employee.job_description = 'Head of Business' 
            OR employee.job_description = 'Head of Legal and Political Desk' 
            OR employee.job_description = 'News Editor'
            OR employee.job_description = 'Supervising News Editor'
                                  ORDER BY applied_date DESC
                                  LIMIT 10";
                    $result = mysqli_query($dbcon, $query);
                    ...
                    ?>
                      <tr onclick="window.location='subleaverequests.php?leave_id=<?php echo $row['leave_id']; ?>';" style="cursor:pointer;" onMouseOver="this.style.background='#c4c4c4'" onMouseOut="this.style.background='#ffffff'">
                        <td class="is-size-6 ">
