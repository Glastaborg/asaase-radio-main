                ...
                <div class="table-container">
                  <table class="table is-narrow is-fullwidth has-background-transparent">
                    ...
                    <?php } else { ?>
                      <tr>
                        <td>
                            <div class="notification is-danger is-light is-flex is-align-items-center">
                ...
                <table class="table is-fullwidth has-background-transparent">
                  <tbody>
                    ...
                    $query = "SELECT *, DATEDIFF(date_to,date_from) AS date_diff FROM employee
                                  ...
                                  AND employee.job_description='Employee' AND employee.department='Finance'
  ...
  function drawChart() {
    var data = google.visualization.arrayToDataTable([
      ...
      $query = "SELECT SUM(week_collection.col_week_amt) AS weekamout,
                ...
                FROM week_collection
                WHERE week_collection.branch = '$sessbranch'
                AND archive_wcol = 'No'";
      $result = mysqli_query($dbcon, $query);
  ...
  function drawChart() {
    var data = google.visualization.arrayToDataTable([
      ...
      $query = "SELECT SUM(year_collection.year_col_budget) AS colbudget,
                ...
                WHERE year_collection.branch = '$sessbranch'
                AND archive_ycol = 'No'";
      $result = mysqli_query($dbcon, $query);
      while ($row = mysqli_fetch_assoc($result)) {
  ...
  function drawChart() {
    var data = google.visualization.arrayToDataTable([
      ...
      $query = "SELECT pay_rec.type AS type, SUM(pay_rec.amount) AS amount
                FROM pay_rec
                WHERE pay_rec.branch = '$sessbranch'
