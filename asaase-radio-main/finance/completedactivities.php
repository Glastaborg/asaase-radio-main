...
include('assets/delete.php');
  ...
  $query = "SELECT activities.* FROM activities
            ...
            AND branch <> 'Admin' AND department = '$sessdepartment'
            AND archive_act = 'No'
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Department Head Completed Activities </title>
    <!-- CSS Links-->
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-success m-1" title="view event"  href="viewactivities.php?activity_id=<?php echo $row['activity_id']; ?>">
