...
include('assets/delete.php');
  ...
  $query = "SELECT *, DATEDIFF(date_to,date_from) AS date_diff FROM employee
            ...
            WHERE archive_leave = 'No' AND employee.job_description='News Editor' OR employee.job_description='Producer' OR employee.job_description='Presenter' 
              ...
              <table class="table is-fullwidth is-striped is-narrow is-hoverable" id="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile"><?php echo $row['date_diff']; ?></td>
