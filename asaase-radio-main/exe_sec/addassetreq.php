      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            ...
            <div class="column is-full">
              <form class="columns is-multiline" action="addassetreq.php" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  ...
                  <div class="field" hidden>
                    ...
                    <div class="control">
                      <input type="text" class="input" name="department" value="<?php echo $_SESSION['department']; ?>" readonly >
                    </div>
                  </div>
                  <div class="field">
