...
AND employee.job_description = 'Department Head' 
     ...
     OR employee.job_description = 'Employee'
     OR employee.job_description = 'Programs Manager'
    AND employee.department = 'HR'
                ...
                ?>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <?php $postions = ['HR Assistant', 'Office Manager', 'Facility Manager', 'Programs Manager', 'General Manager', 'Receptionist', 'Department Head', 'Head of Security', 'Transport Coordinator', 'Head of Research', 'Branch Manager']; ?>
                      <?php if ($row['department'] == "HR" and $row['leave_status'] == "Pending") { ?>
                        <a class="button is-size-7 is-info m-1" title="update leave" href="editleave.php?leave_id=<?php echo $row['leave_id']; ?>">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a class="button is-size-7 is-danger m-1" title="delete leave" href="employeeleave.php?leave_id=<?php echo $row['leave_id']; ?>">
                        <i class="fas fa-trash-alt"></i>
                      </a>
                      <?php } ?>
                       <!-- (in_array($row['job_description'], $postions)) { ?> -->
