      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            ...
            <div class="column is-full">
              <form class="columns is-multiline" action="addjobreq.php" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <input class="input" name="jr_salary" type="number" step="0.01" min="1.00"  placeholder="0.00">
                    </div>
                  </div>
                  <div class="field">
