      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            ...
            <div class="column is-full">
              <form class="columns is-multiline" action="addannexp.php" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  <div class="field">
                    <label class="label">Annual Budgeted Expense <span class="has-text-danger">*</span></label>
                    <div class="control">
                      <input class="input" name="annual_amount" type="number" min="0.01" step="any" placeholder="Enter Amount" required>
                    </div>
                  </div>
                  <div class="field">
                    <label class="label">Year <span class="has-text-danger">*</span></label>
                    <div class="control">
                      <input class="input" name="exp_year" type="number" min="<?php echo date('Y'); ?>" max='2099'  step="1" value="<?php echo date('Y'); ?>" required>
                    </div>
                  </div>
                  ...
                  <div class="field is-grouped my-5">
                    ...
                    <p class="control">
                      <button class="button is-info" name="addannualexp">
                        &nbsp; Save &nbsp;
                      </button>
                    </p>
                  </div>
