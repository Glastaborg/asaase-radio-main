...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Admin Edit Recievables Report </title>
    <!-- CSS Links-->
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">Edit Recievables</a></li>
          </ul>
        </nav>
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            <div class="column is-full" style="border-bottom: 1px solid #c7c7c7;">
              <h1 class="title is-size-5">Edit Recievables</h1>
            </div>
            ...
            <div class="column is-full">
              ...
              ?>
              <form class="columns is-multiline" action="editrecievables.php?pay_rec_id=<?php echo $pay_rec_id; ?>" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  <div class="field">
                      ...
                      <input type="text"  name="pay_rec_id" value="<?php echo $data['pay_rec_id']; ?>" hidden required>
          						...
          						<datalist name="branch" id="branchlist">
          						  <option value="<?php echo $data['branch']; ?>" selected></option>
          						  <?php
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <input class="input" name="amount" type="number" step="0.01" value="<?php echo $data['amount']; ?>" required>
                    </div>
                  </div>
                  <div class="field">
                  ...
                  <div class="field is-grouped my-5">
                    ...
                    <p class="control">
                      <button class="button is-info" name="updaterecievables">
                        &nbsp; Update &nbsp;
                      </button>
                    </p>
                  </div>
