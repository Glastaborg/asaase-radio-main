...
if(isset($_GET['insets_id'])){
  ...
  $query = "SELECT * FROM insets
            WHERE insets.insets_id = '$insets_id'";
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Department Head Unplayed Insets </title>
    <!-- CSS Links-->
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li><a href="uinsets.php" aria-current="page">Unplayed Insets</a></li>
            <li class="is-active"><a href="#" aria-current="page">View Unplayed Insets</a></li>
          </ul>
        </nav>
            ...
            <div class="columns">
              <div class="column is-half">
                <p class="has-text-left">
                  <a href="edituinsets.php?insets_id=<?php echo $row['insets_id']; ?>" class="button is-info mb-2">Edit Unplayed Insets Details</a>
                </p>
              </div>
              <div class="column is-half">
          ...
          <div class="column is-full" id="report">
            <div class="columns is-multiline">
              <div class="column is-full">
                ...
                <h2 class="title is-size-4 has-text-centered">UNPLAYED INSETS DETAILS</h2>
              ...
              <div class="column is-full is-align-items-center">
                <div class="table-container">
                  <table class="table is-fullwidth is-striped is-bordered is-narrow is-hoverable" id="table">
                    ...
                    <tbody>
                      <tr>
                        <td class="is-size-6 is-size-7-mobile pb-5" ><?php echo $row['comment']; ?></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
