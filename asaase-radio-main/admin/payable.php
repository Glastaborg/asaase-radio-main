...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Admin Payables Report </title>
    <!-- CSS Links-->
            ...
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  ...
                  &nbsp;&nbsp;
                  <a class="is-active">Payables Reports</a>
                </p>
              </div>
            </div>
          </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-info m-1" title="view week recievable"  href="viewpayable.php?pay_rec_id=<?php echo $row['pay_rec_id']; ?>">
          ...
          <div class="column is-full">
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='payable.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='payable.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href=payable.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
