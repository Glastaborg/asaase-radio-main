...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Login </title>
    <!-- CSS Links-->
      ...
      <div class="section ">
        <div class="columns mt-5 has-brown-down-borderline">
          <div class="column has-background-white is-12 py-3 mt-6">
            ...
            <h2 class="title is-size-4 px-3 has-text-brown">Login.</h2>
            <form class="px-3" action="index.php" method="post">
              ...
              <div class="field is-grouped my-1">
                <p class="control is-expanded is-size-6">
                  <a href="forget.php" class="is-size-7" id="forget">Forgot password...?</a>
                </p>
              </div>
              <div class="field is-grouped my-5">
                ...
                <p class="control">
                  <button class="button has-background-brown has-text-white" name="login">
                    &nbsp; Login &nbsp;
                  </button>
                </p>
              </div>
