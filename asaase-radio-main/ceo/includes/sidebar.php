<div class="menu px-4 is-2 pb-6 has-background-brown  active" id="aside">
 ...
 <aside class="px-2 mt-5">
    ...
    <p class="menu-label is-size-7 has-text-white">Uploaded Documents</p>
    <ul class="menu-list">     
      <li>
    ...
    <ul class="menu-list">
      ...
      <li>
        <a href="employeesleavereports.php" class="has-icons-left has-text-white">
          <span class="icon is-small is-left">
            <i class="far fa-file-alt"></i>
          </span>
      ...
      <li>
        <a href="wcolreports.php" class="has-icons-left has-text-white">
          <span class="icon is-small is-left">
            <i class="far fa-file-alt"></i>
          </span>
        Finance Report
