                ...
                <div class="column is-half">
                  <div class="field">
                    ...
                    <div class="control">
                      ...
                      <input class="input" name="sales_target_yet" type="number" min="0.01" step="any" value="<?php echo $data['sales_target_yet']; ?>" required>
                    </div>
                  </div>
                  <div class="field">
                    <label class="label">Sales to Date <span class="has-text-danger">*</span></label>
                    <div class="control">
                      <input class="input" name="sales_to_date" type="number" min="0.01" step="any" value="<?php echo $data['sales_to_date']; ?>" required>
                    </div>
                  </div>
                  <div class="field">
