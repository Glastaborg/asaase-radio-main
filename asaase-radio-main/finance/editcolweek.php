              ...
              <form class="columns is-multiline" action="editcolweek.php?week_col_id=<?php echo $week_col_id; ?>" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  <div class="field">
                    ...
                    <div class="control">
                      <input name="week_col_id" hidden type="number" value="<?php echo $data['week_col_id']; ?>" required>
                      <input class="input" name="col_week_amt" type="number" min="0.01" step="any" value="<?php echo $data['col_week_amt']; ?>" required>
                    </div>
                  </div>
                  <div class="field">
                    <label class="label">Total Collection Budget Annual <span class="has-text-danger">*</span></label>
                    <div class="control">
                      <input class="input" name="col_budget_amt" type="number" min="0.01" step="any" value="<?php echo $data['col_budget_amt']; ?>" required>
                    </div>
                  </div>
                  <div class="field">
