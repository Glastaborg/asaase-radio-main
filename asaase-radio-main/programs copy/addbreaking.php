...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Department Head Add Breaking News </title>
    <!-- CSS Links-->
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">Add Breaking News</a></li>
          </ul>
        </nav>
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            <div class="column is-full" style="border-bottom: 1px solid #c7c7c7;">
              <h1 class="title is-size-5">Add Breaking News</h1>
            </div>

            <div class="column is-full">
              <form class="columns is-multiline" action="addbreaking.php" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <textarea class="textarea" name="comment" rows="3" placeholder="Enter Description" required></textarea>
                    </div>
                  </div>
                  <div class="field">
                    <label class="label">Number of Times <span class="has-text-danger">*</span></label>
                    <div class="control">
                      <input class="input" name="amt" type="number" step="1" placeholder="Enter umber of Times" required>
                    </div>
                  </div>
                  <div class="field">
                    ...
                    <div class="control pr-5" >
                      <div class="select ">
                        <select name="type" required>
                          <option selected disabled>Select Where News is From</option>
                          <option>Web</option>
                  ...
                  <div class="field is-grouped my-5">
                    ...
                    <p class="control">
                      <button class="button is-info" name="addbreaking">
                        &nbsp; Save &nbsp;
                      </button>
                    </p>
                  </div>
