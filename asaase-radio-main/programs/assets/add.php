...
if (isset($_POST['addprogram'])) {
  ...
  $query = "INSERT INTO `programs` (program, hostname, branch, producer, archive_program,dj,program_desc, program_color,cohost, producers)
            VALUES ('$program','$hostname','$branch','$producer', '$archive_program','$dj','$program_desc', '$program_color','$cohost','$producers')";
  $result = mysqli_query($dbcon, $query);
...
<?php 
  ...
  $query = "INSERT INTO `scripts` (program_id, guest, script, date, archive_script, panelist)
            VALUES ('$program_id','$guest','$script','$date', '$archive_script','$panelist')";
  $result = mysqli_query($dbcon, $query);
