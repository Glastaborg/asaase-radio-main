      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li><a href="payable.php" aria-current="page">Payables Reports</a></li>
            <li class="is-active"><a href="#" aria-current="page">View Payables Report</a></li>
          </ul>
        </nav>
            ...
            <div class="columns">
              <div class="column is-half">
                <p class="has-text-left">
                  <a href="editpayable.php?pay_rec_id=<?php echo $row['pay_rec_id']; ?>" class="button is-info mb-2">Edit Payable Details</a>
                </p>
              </div>
              <div class="column is-half">
          ...
          <div class="column is-full" id="report">
            <div class="columns is-multiline">
              <div class="column is-full">
                ...
                <h2 class="title is-size-4 has-text-centered">PAYABLE DETAILS</h2>
