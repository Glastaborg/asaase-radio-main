...
if(isset($_GET['page'])){
  ...
  $query = "SELECT *, assets.branch AS assbranch FROM asset_employee
            ...
            ORDER BY col_date DESC, assets.branch
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            ...
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  ...
                  &nbsp;&nbsp;
                  <a class="is-active">Assigned Assets</a>
                  &nbsp;&nbsp;
              ...
              <table class="table is-fullwidth is-striped is-narrow is-hoverable" id="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile"><?php echo $row['assbranch']; ?></td>
          ...
          <div class="column is-full">
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                $pr_query = "SELECT *, assets.branch AS assbranch FROM asset_employee
                              INNER JOIN assets ON assets.asset_id = asset_employee.asset_id
                              INNER JOIN employee ON employee.employee_id = asset_employee.employee_id
                              ORDER BY col_date DESC, assets.branch";
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='assetemployee.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='assetemployee.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href=assetemployee.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
