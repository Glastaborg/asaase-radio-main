      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li ><a href="wcolreports.php" aria-current="page">Weekly Collection Reports</a></li>
            <li class="is-active"><a href="#" aria-current="page">Generate Report</a></li>
          </ul>
        </nav>
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">

          <form class="column is-half" action="genwcol.php" method="post">
            <h1 class="title is-size-5">Generate Weekly Collection Report</h1>
            <div class="field">
            ...
            <div class="field is-grouped my-5">
              ...
              <p class="control">
                <button class="button is-info" name="genwcol">
                  &nbsp; Generate &nbsp;
                </button>
              </p>
            </div>
