        ...
        <tbody>
            <tr>
                <td colspan="2">
                    ...
                    <div class="control p-3" style="min-height:40px; border:1px solid #d5d5d5; border-radius:4px;">
                        <textarea style="min-height:40px; "  name="mgn_comment" rows="5" placeholder="Enter Manager Comment" id="mgn_comment" ></textarea>
                    </div>
                    </div>
                </td>
            </tr>          
            <tr>
                <td  colspan="2" class="has-text-right">
                    <button class="button is-info" name="mgn_update">
                    &nbsp;Update &nbsp;
                    </button>
                </td>
            </tr>
