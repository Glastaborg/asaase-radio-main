            ...
            <div class="column is-full">
              ...
              <form class="columns is-multiline" action="editevent.php?event_id=<?php echo $event_id; ?>" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  ...
                  <div class="control">
                      <input type="text" name="event_name" class="input" value="<?php echo $data['name']?>" required readonly>
                  </div>
                ...
                <div class="field">
                    ...
                    <div class="control">
                      <input class="input" id="event_date" name="event_date" min="<?php echo date("Y-m-d"); ?>"  value="<?php echo $data['date']?>" type="date" readonly required>
                    </div>
                </div>
               <div class="field">
               ...
               <div class="field">
                  <label for="" class="label">List of Crew Members<span class="has-text-danger " >*</span></label>
                  <div class="control">
                      <textarea class="textarea" name="crew_members" id="" value="<?php echo $data['crew_list']?>" cols="30" rows="10" placeholder="Separate Names with ," readonly required><?php echo $data['crew_list']?></textarea>
                  </div>
               </div>
                <div class="field">
                  ...
                  <div class="control">
                      <select name="status" id="" class="input" required>
                          ...
                          <option value="Pending" <?php if($data['finance_status'] == "Pending"){echo 'selected';}?>>Pending</option>
                          <option value="Granted" <?php if($data['finance_status'] == "Granted"){echo 'selected';}?> >Granted</option>
                          <option value="Rejected" <?php if($data['finance_status'] == "Rejected"){echo 'selected';}?> >Rejected</option>
                      </select>
                  </div>
                </div>
