...
if(isset($_GET['year_col_id'])){
  ...
  $query = "SELECT * FROM year_collection
            WHERE year_collection.year_col_id = '$year_col_id'";
...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Department Head Yealy Finance Report </title>
    <!-- CSS Links-->
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li><a href="ycolreports.php" aria-current="page">Yealy Collection</a></li>
            <li class="is-active"><a href="#" aria-current="page">View Yealy Collection Reports</a></li>
          </ul>
        </nav>
            ...
            <div class="columns">
              <div class="column is-half">
                <p class="has-text-left">
                  <a href="editcolyear.php?year_col_id=<?php echo $row['year_col_id']; ?>" class="button is-info mb-2">Edit Weekly Collection Details</a>
                </p>
              </div>
              <div class="column is-half">
          ...
          <div class="column is-full" id="report">
            <div class="columns is-multiline">
              <div class="column is-full">
                ...
                <h2 class="title is-size-4 has-text-centered">YEARLY COLLECTION DETAILS</h2>
              ...
              <div class="column is-full is-align-items-center">
                <div class="table-container">
                  <table class="table is-fullwidth is-striped is-bordered is-narrow is-hoverable" id="table">
                    <thead>
                      <tr>
                        <th class="is-size-6 is-size-7-mobile">Yearly Budget (GHS)</th>
                        <th class="is-size-6 is-size-7-mobile">Yearly Annual (GHS)</th>
                        <th class="is-size-6 is-size-7-mobile">Reasons for Difference</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td class="is-size-6 is-size-7-mobile pb-5"><?php echo $row['year_col_budget']; ?></td>
                        <td class="is-size-6 is-size-7-mobile pb-5"><?php echo $row['year_col_annual']; ?></td>
