...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Department Head Unplayed Insets Report </title>
    <!-- CSS Links-->
    ...
    <div class="columns">
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          ...
          <form class="column is-half" action="genuinsets.php" method="post">
            <h1 class="title is-size-5">Generate Unplayed Insets Report</h1>
            <div class="field">
            ...
            <div class="field is-grouped my-5">
              ...
              <p class="control">
                <button class="button is-info" name="genuinsets">
                  &nbsp; Generate &nbsp;
                </button>
              </p>
            </div>
