...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Employee Activities </title>
    <!-- CSS Links-->
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-info m-1" title="view event"  href="viewactivity.php?activity_id=<?php echo $row['activity_id']; ?>">
          ...
          <div class="column is-full">
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='activities.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='activities.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href='activities.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
