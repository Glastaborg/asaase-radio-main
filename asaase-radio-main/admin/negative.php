...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Admin Negative Feedback </title>
    <!-- CSS Links-->
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" >
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Negative Feedback Reports</h1>
              </div>
              <div class="column">
                <div class="field">
            ...
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  ...
                  &nbsp;&nbsp;
                  <a class="is-active">Negative Feedback</a>
                  &nbsp;&nbsp;
          ...
          <div class="column is-full">
            <div class="columns">
              <div class="column is-half">
                <a href="addnegative.php" class="button is-info " type="button" name="button" id="addbtn">Add Negative Feedback</a>
              </div>
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="genneg.php" class="button is-white" type="button" name="button" id="addbtn">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-info m-1" title="view negative feedback"  href="viewnegative.php?neg_fed_id=<?php echo $row['neg_fed_id']; ?>">
                        <i class="fas fa-eye"></i>
                      </a>
                      <a class="button is-size-7 is-info m-1" title="update negative feedback"  href="editnegative.php?neg_fed_id=<?php echo $row['neg_fed_id']; ?>">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a class="button is-size-7 is-danger m-1" title="delete negative feedback"  href="negative.php?neg_fed_id=<?php echo $row['neg_fed_id']; ?>">
          ...
          <div class="column is-full">
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                $pr_query = "SELECT * FROM negative_fed
                            ORDER BY date DESC, branch";
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='negative.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='negative.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href=negative.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
