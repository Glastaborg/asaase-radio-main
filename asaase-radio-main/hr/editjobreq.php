              ...
              <form class="columns is-multiline" action="editjobreq.php?jr_id=<?php echo $jr_id; ?>" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <textarea class="textarea" name="jr_request" rows="2" required <?php if ($data['jr_status'] === "Declined") { echo 'readonly'; }?>><?php echo $data['jr_request']; ?></textarea>
                    </div>
                  </div>
                  <div class="field">
                    <label class="label">Role <span class="has-text-danger">*</span></label>
                    <div class="control">
                      <input class="input" name="jr_role" type="text" value="<?php echo $data['jr_role']; ?>" required <?php if ($data['jr_status'] === "Declined") { echo 'readonly'; }?>>
                    </div>
                  </div>
                  <div class="field">
                    <label class="label">Expected Date <span class="has-text-danger">*</span></label>
                    <div class="control">
                      <input class="input" name="jr_exp_date" type="date" value="<?php echo $data['jr_exp_date']; ?>" required <?php if ($data['jr_status'] === "Declined") { echo 'readonly'; }?>>
                    </div>
                  </div>
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <input class="input" name="jr_salary" type="number" step="0.01"  value="<?php echo $data['jr_salary']; ?>" <?php if ($data['jr_status'] === "Declined") { echo 'readonly'; }?>>
                    </div>
                  </div>
                  <div class="field">
                    ...
                    <div class="control">
                      ...
                      <input class="radio" name="jr_budgeted" type="radio" value="Yes" required <?php if ($data['jr_budgeted'] === "Yes") {echo "checked"; } ?> <?php if ($data['jr_status'] === "Declined") { echo 'readonly'; }?>> Yes
                      <input class="radio" name="jr_budgeted" type="radio" value="No"  required <?php if ($data['jr_budgeted'] === "No") {echo "checked"; } ?> <?php if ($data['jr_status'] === "Declined") { echo 'readonly'; }?>> No
                    </div>
                  </div>
                  <div class="field preason">
                    <label class="label">If not budgeted for, give reasons<span class="has-text-danger">*</span></label>
                    <div class="control">
                      <textarea class="textarea reason" name="jr_reason" rows="2" <?php if ($data['jr_status'] === "Declined") { echo 'readonly'; }?>><?php echo $data['jr_reason']; ?></textarea>
                    </div>
                  </div>
                  
                    <div class="field" <?php if ($data['jr_status'] === "Pending") {echo 'hidden';} ?>>
                      <label class="label">Job Request Status<span class="has-text-danger">*</span></label>
                      <div class="control" >
                        <input type="text" class="input" name="jr_status" value="<?php echo $data['jr_status']; ?>" readonly >
                      </div>
                    </div>
                    <div class="field" <?php if ($data['jr_status'] === "Pending") {echo 'hidden';} ?>>
                      <label class="label">Reasons for decline<span class="has-text-danger">*</span></label>
                      <div class="control">
                        <textarea class="textarea" name="jr_decline" rows="2" <?php if ($data['jr_status'] === "Declined") {echo 'required';} ?>><?php echo $data['jr_decline']; ?></textarea>
                      </div>
                    </div>
