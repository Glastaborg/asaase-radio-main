...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Admin Edit Employees Reports</title>
    <!-- CSS Links-->
              ...
              <form class="columns is-multiline" action="editempreport.php?employee_report_id=<?php echo $employee_report_id; ?>" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  <div class="field">
                      ...
                      <input type="text" name="employee_report_id" value="<?php echo $data['employee_report_id']; ?>" required hidden>
          						...
          						<datalist name="employee_id" id="employeelist">
          						  <option selected value="<?php echo $data['employee_id']; ?>">
                          <?php echo $data['firstname']; ?> <?php echo $data['lastname']; ?> - <?php echo $data['branch']; ?> || <?php echo $data['department']; ?>
                        </option>
          						  <?php
                  ...
                  <div class="field">
                        ...
                        <option selected value="<?php echo $data['activity_id']; ?>">
                          <?php echo $data['activity_name']; ?> || <?php echo $data['department']; ?> - <?php echo $data['activity_date']; ?>
                        </option>
          						  <?php
