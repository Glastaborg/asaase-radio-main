      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">Add Sales</a></li>
          </ul>
        </nav>
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            <div class="column is-full" style="border-bottom: 1px solid #c7c7c7;">
              <h1 class="title is-size-5">Add Sales</h1>
            </div>

            <div class="column is-full">
              <form class="columns is-multiline" action="addsalesyet.php" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  <div class="field">
                    <label class="label">Sales Target Yet to Date<span class="has-text-danger">*</span></label>
                    <div class="control">
                      <input class="input" name="sales_target_yet" type="number" min="0.01" step="any" placeholder="Enter Sales Target Yet to Date" required>
                    </div>
                  </div>
                  <div class="field">
                    <label class="label">Sales to Date <span class="has-text-danger">*</span></label>
                    <div class="control">
                      <input class="input" name="sales_to_date" type="number" min="0.01" step="any" placeholder="Enter Sales to Date" required>
                    </div>
                  </div>
                  <div class="field">
                  ...
                  <div class="field is-grouped my-5">
                    ...
                    <p class="control">
                      <button class="button is-info" name="addyetsales">
                        &nbsp; Save &nbsp;
                      </button>
                    </p>
                  </div>
