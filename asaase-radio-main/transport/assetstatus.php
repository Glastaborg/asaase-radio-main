      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">Vehicle Status</a></li>
          </ul>
        </nav>
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" >
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Vehicle Status</h1>
              </div>
              <div class="column">
                <div class="field">
          ...
          <div class="column is-full">
            <div class="columns">
              <div class="column is-half">
                <a href="addassetstatus.php" class="button is-info " type="button" name="button" id="addbtn">Add Vehicle Status</a>
              </div>
              <div class="column is-half">
          ...
          <div class="column is-full">
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="archiveassetstat.php" class="button is-white" type="button" name="button" id="addbtn">
          ...
          <div class="column is-full is-align-items-center">
            <div class="table-container">
              <table class="table is-fullwidth is-striped is-narrow is-hoverable" id="table">
                <thead>
                  <tr>
                    <th class="is-size-6 is-size-7-mobile">Number Plate</th>
