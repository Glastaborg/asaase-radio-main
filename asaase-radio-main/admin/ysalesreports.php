        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" >
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Yet to Date Sales Reports</h1>
              </div>
              <div class="column">
                <div class="field">
          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  <a href="wsalesreports.php">Weekly Sales Reports</a>
                  &nbsp;&nbsp;
                  <a class="is-active">Yet To Sales Reports</a>
                </p>
              </div>
            </div>
          </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-info m-1" title="view week sales"  href="viewysales.php?yet_sales_id=<?php echo $row['yet_sales_id']; ?>">
                      ...
                      <a class="button is-size-7 is-danger m-1" title="delete week sales"  href="ysalesreports.php?yet_sales_id=<?php echo $row['yet_sales_id']; ?>">
          ...
          <div class="column is-full">
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                $pr_query = "SELECT * FROM yet_sales
                             ORDER BY date DESC, branch";
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='ysalesreports.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='ysalesreports.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href='ysalesreports.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
