              ...
              <form class="columns is-multiline" action="addcolweek.php" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <input class="input" name="col_week_amt" type="number" step="0.01" placeholder="Enter Total Collection for The Week" required>
                    </div>
                  </div>
                  <div class="field">
                    <label class="label">Total Collection Budget Annual <span class="has-text-danger">*</span></label>
                    <div class="control">
                      <input class="input" name="col_budget_amt" type="number" step="0.01" placeholder="Enter Total Collection Budget Annual" required>
                    </div>
                  </div>
                  <div class="field">
