...
$query = "SELECT *, DATEDIFF(date_to,date_from) AS date_diff FROM employee
            ...
            WHERE archive_leave = 'No' AND employee.job_description = 'Brands and Comms' OR employee.job_description = 'Creative designers' OR employee.job_description='Social Media'
