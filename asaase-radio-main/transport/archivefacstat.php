...
include('assets/restore.php');
  ...
  $query = "SELECT * FROM facility_status
            ...
            AND archive_facility_status = 'Yes'
          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" >
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Archived Facility Status</h1>
              </div>
              <div class="column">
                <div class="field">
            ...
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="facilitystatus.php" class="button is-white" type="button" name="button" id="addbtn">
                    <i class="fas fa-house-damage"></i>&nbsp; View All acility Status
                  </a>
                </p>
              </div>
            </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-success m-1" title="restore facility status"  href="archivefacstat.php?facility_status_id=<?php echo $row['facility_status_id']; ?>">
