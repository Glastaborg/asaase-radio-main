        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          <div class="column is-full">
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  <a >Accra Program Lineup</a>
                  <?php
                    $progbranch = "SELECT * FROM branch WHERE branch <> 'Accra' AND branch <> 'Admin'";
                    $progresult =  mysqli_query($dbcon, $progbranch);
                    while ($progrow = mysqli_fetch_array($progresult)){

                   ?>
                  &nbsp;&nbsp;
                  <a href="otherprogsched.php?branch=<?php echo $progrow['branch']; ?>"><?php echo $progrow['branch']; ?> Program Lineup</a>
                  <?php } ?>
                </p>
              </div>
            </div>
          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1">
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Accra Program Lineup</h1>
              </div>
              <div class="column">
                <a href="addprogramsched.php" class="button is-info" type="button" name="button">Add Program Lineup</a>
              </div>
            </div>
          </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    ...
                                    WHERE  day = 'Monday' AND programs.branch = 'Accra' ORDER BY start_time ASC";
                  ...
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    INNER JOIN programs ON programs.program_id = program_schedule.program_id
                                    WHERE  day = 'Tuesday' AND programs.branch = 'Accra'  ORDER BY start_time ASC";
                      $mon1result = mysqli_query($dbcon, $mon1query);
                      while ($mon1row = mysqli_fetch_array($mon1result)) {
                    ?>
                    <td>
                  ...
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    INNER JOIN programs ON programs.program_id = program_schedule.program_id
                                    WHERE  day = 'Wednesday' AND programs.branch = 'Accra' ORDER BY start_time ASC";
                      $mon1result = mysqli_query($dbcon, $mon1query);
                      while ($mon1row = mysqli_fetch_array($mon1result)) {
                    ?>
                    <td>
                  ...
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    INNER JOIN programs ON programs.program_id = program_schedule.program_id
                                    WHERE  day = 'Thursday' AND programs.branch = 'Accra' ORDER BY start_time ASC";
                      $mon1result = mysqli_query($dbcon, $mon1query);
                      while ($mon1row = mysqli_fetch_array($mon1result)) {
                    ?>
                    <td>
                  ...
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    INNER JOIN programs ON programs.program_id = program_schedule.program_id
                                    WHERE  day = 'Friday' AND programs.branch = 'Accra' ORDER BY start_time ASC";
                      $mon1result = mysqli_query($dbcon, $mon1query);
                      while ($mon1row = mysqli_fetch_array($mon1result)) {
                    ?>
                    <td>
                  ...
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    INNER JOIN programs ON programs.program_id = program_schedule.program_id
                                    WHERE  day = 'Saturday' AND programs.branch = 'Accra' ORDER BY start_time ASC";
                      $mon1result = mysqli_query($dbcon, $mon1query);
                      while ($mon1row = mysqli_fetch_array($mon1result)) {
                    ?>
                    <td>
                  ...
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    INNER JOIN programs ON programs.program_id = program_schedule.program_id
                                    WHERE  day = 'Sunday' AND programs.branch = 'Accra' ORDER BY start_time ASC";
                      $mon1result = mysqli_query($dbcon, $mon1query);
                      while ($mon1row = mysqli_fetch_array($mon1result)) {
                    ?>
                    <td>
