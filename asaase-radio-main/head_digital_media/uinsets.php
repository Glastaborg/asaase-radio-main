        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          ...
          <div class="column is-full">
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="archiveuinsets.php" class="button is-white" type="button" name="button" id="addbtn">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-success m-1" title="view unplayed insets"  href="viewuinsets.php?insets_id=<?php echo $row['insets_id']; ?>">
