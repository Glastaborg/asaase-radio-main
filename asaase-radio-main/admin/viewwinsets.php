      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">View Wrong Insets</a></li>
          </ul>
        </nav>
            ...
            <div class="columns">
              <div class="column is-half">
                <p class="has-text-left">
                  <a href="editwinsets.php?insets_id=<?php echo $row['insets_id']; ?>" class="button is-info mb-2">Edit Wrong Insets Details</a>
                </p>
              </div>
              <div class="column is-half">
          ...
          <div class="column is-full" id="report">
            <div class="columns is-multiline">
              <div class="column is-full">
                ...
                <h2 class="title is-size-4 has-text-centered">WRONG INSETS DETAILS</h2>
