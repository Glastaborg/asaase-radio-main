...
$query = "SELECT *, DATEDIFF(date_to,date_from) AS date_diff FROM employee
            ...
            WHERE archive_leave = 'No' AND employee.branch='$sessbranch' AND employee.branch != 'Accra' AND employee.job_description ='Department Head' AND employee.department ='HR'
