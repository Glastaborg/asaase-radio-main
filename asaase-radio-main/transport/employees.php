...
$query = "SELECT employee.* FROM employee
          WHERE employee.department = 'Transport'
          AND job_description = 'Employee'
          AND employee.archive_emp = 'No'
...
<head>
  ...
  <title>Asaase Radio || Transport Employees</title>
  <!-- CSS Links-->
    ...
    <div class="column is-10 has-background-light" id="main">
      ...
      <nav class="breadcrumb p-3" aria-label="breadcrumbs">
        <ul>
          ...
          <li class="is-active"><a href="#" aria-current="page">Transport Employees</a></li>
        </ul>
      </nav>
        ...
        <div class="column is-full">
          <div class="columns is-align-items-center py-1">
            <div class="column is-two-thirds">
              <h1 class="title is-size-5">Transport Employees</h1>
            </div>
            <div class="column">
              <div class="field">
