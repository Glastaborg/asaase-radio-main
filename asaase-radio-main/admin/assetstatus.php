...
if(isset($_GET['page'])){
  ...
  $query = "SELECT *, asset_status.date AS asset_status_date FROM asset_status
            ...
            ORDER BY asset_status.date DESC, branch
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" >
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Assets Status</h1>
              </div>
              <div class="column">
                <div class="field">
            ...
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  ...
                  &nbsp;&nbsp;
                  <a class="is-active">Asset Status</a>
                  &nbsp;&nbsp;
                  <a href="assetemployee.php">Assigned Assets</a>
                  &nbsp;&nbsp;
                  <a href="facility.php">Facility</a>
                  &nbsp;&nbsp;
                  <a href="facilitystatus.php">Facility Status</a>
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="column is-full">
            <div class="columns">
              <div class="column is-half">
                <a href="addassetstatus.php" class="button is-info " type="button" name="button" id="addbtn">Add Asset Status</a>
              </div>
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="genasstat.php" class="button is-white" type="button" name="button" id="addbtn">
          ...
          <div class="column is-full is-align-items-center">
            <div class="table-container">
              <table class="table is-fullwidth is-striped is-narrow is-hoverable" id="table">
                <thead>
                  <tr>
                    <th class="is-size-6 is-size-7-mobile">Assets ID</th>
                    <th class="is-size-6 is-size-7-mobile">Assets</th>
                    <th class="is-size-6 is-size-7-mobile">Description</th>
                    <th class="is-size-6 is-size-7-mobile">Asset Status</th>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile"><?php echo $row['asset_status_date']; ?></td>
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-info m-1" title="update asset status"  href="editassetstatus.php?asset_status_id=<?php echo $row['asset_status_id']; ?>">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a class="button is-size-7 is-danger m-1" title="delete asset status"  href="assetstatus.php?asset_status_id=<?php echo $row['asset_status_id']; ?>">
          ...
          <div class="column is-full">
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                $pr_query = "SELECT *, asset_status.date AS asset_status_date  FROM asset_status
                             INNER JOIN assets ON assets.asset_id = asset_status.asset_id
                             ORDER BY asset_status.date DESC, branch";
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='assetstatus.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='assetstatus.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href=assetstatus.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
