      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li><a href="part-d.php?perf_part_d_id=<?php echo $_SESSION['perf_id']; ?>"> &nbsp; Part C</a></li>
            <li class="is-active"><a href="#" aria-current="page">Edit Part D</a></li>
          </ul>
        </nav>
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          ...
          <div class="column is-full">
            <div class="columns">
              <div class="column is-half">
                <a href="part-d.php?perf_part_d_id=<?php echo $_SESSION['perf_id']; ?>" class="button is-info" name="button" id="addbtn">Back</a>
              </div>
              <div class="column is-half">
          ...
          <!-- including form -->
          <?php include('includes/part-d-uform.php');?>
