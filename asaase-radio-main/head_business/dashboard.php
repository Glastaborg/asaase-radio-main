            ...
            <div class="card-content">
              ...
              <p class="subtitle has-text-centered has-text-grey-dark">
                ...
                $query = "SELECT COUNT(employee_id) AS totalemployee
                              ...
                              AND archive_emp = 'No'
                              AND job_description = 'Creative designer'
                ...
                <table class="table is-fullwidth has-background-transparent">
                  <tbody>
                    ...
                    $query = "SELECT *, DATEDIFF(date_to,date_from) AS date_diff FROM employee
                                  ...
                                  AND leave_status = 'Pending' AND employee.job_description = 'Creative designer'
                                  AND employee.department = 'News'
                    ...
                    ?>
                      <tr onclick="window.location='editsubleaverequests.php?leave_id=<?php echo $row['leave_id']; ?>';" style="cursor:pointer;" onMouseOver="this.style.background='#c4c4c4'" onMouseOut="this.style.background='#ffffff'">
                        <td class="is-size-6 ">
