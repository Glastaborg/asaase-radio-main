...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Admin Add Session </title>
    <!-- CSS Links-->
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">Add Facility</a></li>
          </ul>
        </nav>
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            <div class="column is-full" style="border-bottom: 1px solid #c7c7c7;">
              <h1 class="title is-size-5">Add Employee Session</h1>
            </div>

            <div class="column is-full">
              <form class="columns is-multiline" action="addsession.php" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  <div class="field">
          					...
          					<div class="control">
          						...
          						<datalist name="employee_id" id="employeelist">
          						  <?php
          						  $query = "SELECT * FROM employee WHERE branch = '$sessbranch' AND deleted = '0'";
                  ...
                  <div class="field is-grouped my-5">
                    ...
                    <p class="control">
                      <button class="button is-info" name="addsession">
                        &nbsp; Save &nbsp;
                      </button>
                    </p>
                  </div>
