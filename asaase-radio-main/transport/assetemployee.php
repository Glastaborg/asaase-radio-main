      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">Vehicle Assignings</a></li>
          </ul>
        </nav>
          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" >
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Vehicle Assignings</h1>
              </div>
              <div class="column">
                <div class="field">
          ...
          <div class="column is-full">
            <div class="columns">
              <div class="column is-half">
                <a href="addassetemployee.php" class="button is-info " type="button" name="button" id="addbtn">Add Vehicle Assigning</a>
              </div>
              <div class="column is-half">
