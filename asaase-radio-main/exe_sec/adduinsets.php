...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Asaase Radio || Department Head Add Wrong Insets </title>
    <!-- CSS Links-->
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">Add Unplayed Insets</a></li>
          </ul>
        </nav>
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            <div class="column is-full" style="border-bottom: 1px solid #c7c7c7;">
              <h1 class="title is-size-5">Add Unplayed Insets</h1>
            </div>

            <div class="column is-full">
              <form class="columns is-multiline" action="adduinsets.php" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  ...
                  <div class="field is-grouped my-5">
                    ...
                    <p class="control">
                      <button class="button is-info" name="adduinsets">
                        &nbsp; Save &nbsp;
                      </button>
                    </p>
                  </div>
