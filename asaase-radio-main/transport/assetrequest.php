              ...
              <table class="table is-fullwidth is-striped is-narrow is-hoverable" id="table">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile"><?php echo $row['driver']; ?></td>
                    <td class="is-size-6 is-size-7-mobile has-text-left">
                        <a class="button is-size-7 is-info m-1" title="update"  href="editassetreq.php?ar_id=<?php echo $row['asset_request_id']; ?>">
                          <i class="fas fa-edit"></i>
                        </a>
                        <a class="button is-size-7 is-danger m-1" title="delete"  href="assetrequest.php?ar_id=<?php echo $row['asset_request_id']; ?>">
