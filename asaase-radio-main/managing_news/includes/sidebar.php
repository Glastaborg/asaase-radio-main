<div class="menu px-4 is-2 pb-6 has-background-brown  active" id="aside">
 ...
 <aside class="px-2 mt-5">
    ...
    <ul class="menu-list">
      ...
      <?php } ?>
      <li>
        <a href="program.php" class="has-icons-left has-text-white">
          <span class="icon is-small is-left">
      ...
      <li>
        <a href="breaking.php" class="has-icons-left has-text-white">
          <span class="icon is-small is-left">
      ...
      <li>
        <a href="negative.php" class="has-icons-left has-text-white">
          <span class="icon is-small is-left">
      ...
      <li>
        <a href="winsets.php" class="has-icons-left has-text-white">
          <span class="icon is-small is-left">
      ...
      <li>
        <a href="uinsets.php" class="has-icons-left has-text-white">
          <span class="icon is-small is-left">
