          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" >
              <div class="column is-half">
                <h1 class="title is-size-5">Archived Agencies</h1>
              </div>
            </div>
          </div>
            ...
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="agency.php" class="button is-white" type="button" name="button" id="addbtn">
                    <i class="far fa-building"></i>&nbsp; View All Agencies
                  </a>
                </p>
              </div>
            </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-success m-1" title="restore agency"  href="archiveagency.php?agency_id=<?php echo $row['agency_id']; ?>">
