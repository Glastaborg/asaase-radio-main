...
include('assets/budgetstatus.php');
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          <div class="column is-full">
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  <a class="is-active">All Activity Budget</a>
                  &nbsp;&nbsp;
                  <a href="approvedbudget.php">Approved Budget</a>
                  &nbsp;&nbsp;
                  <a href="declinedbudget.php">Declined Budget</a>
                  &nbsp;&nbsp;
          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" style="border-bottom: 1px solid #c7c7c7;">
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Activity Budget</h1>
              </div>
              <div class="column">
                <div class="field">
            ...
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="archiveactivitybudget.php" class="button is-white" type="button" name="button" id="addbtn">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      ...
                      <a class="button is-size-7 is-success m-1" title="approve budget"  href="activitybudget.php?approve_budget_id=<?php echo $row['activity_budget_id']; ?>">
                        <i class="fas fa-thumbs-up"></i>
                      </a>
                      <a class="button is-size-7 is-warning m-1" title="decline budget"  href="activitybudget.php?decline_budget_id=<?php echo $row['activity_budget_id']; ?>">
                        <i class="fas fa-thumbs-down"></i>
                      </a>
                    <?php } ?>
                    <?php if ($row['budget_status'] == 'Approved' OR $row['budget_status'] == 'Declined') { ?>
                      <a class="button is-size-7 is-danger m-1" title="delete budget"  href="activitybudget.php?activity_budget_id=<?php echo $row['activity_budget_id']; ?>">
