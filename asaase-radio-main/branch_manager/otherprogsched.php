          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  <?php
                    $progbranch = "SELECT * FROM branch WHERE branch <> 'Admin'";
          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1">
              <div class="column is-two-thirds">
                <h1 class="title is-size-5"><?php echo $branch; ?> Program Lineup</h1>
              </div>
              <div class="column">
                ...
                <tbody>
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    ...
                                    WHERE  day = 'Monday' AND programs.branch = '$branch' ORDER BY start_time ASC";
                  ...
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    INNER JOIN programs ON programs.program_id = program_schedule.program_id
                                    WHERE  day = 'Tuesday' AND programs.branch = '$branch' ORDER BY start_time ASC";
                      $mon1result = mysqli_query($dbcon, $mon1query);
                      while ($mon1row = mysqli_fetch_array($mon1result)) {
                    ?>
                    <td>
                  ...
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    INNER JOIN programs ON programs.program_id = program_schedule.program_id
                                    WHERE  day = 'Wednesday' AND programs.branch = '$branch' ORDER BY start_time ASC";
                      $mon1result = mysqli_query($dbcon, $mon1query);
                      while ($mon1row = mysqli_fetch_array($mon1result)) {
                    ?>
                    <td>
                  ...
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    INNER JOIN programs ON programs.program_id = program_schedule.program_id
                                    WHERE  day = 'Thursday' AND programs.branch = '$branch' ORDER BY start_time ASC";
                      $mon1result = mysqli_query($dbcon, $mon1query);
                      while ($mon1row = mysqli_fetch_array($mon1result)) {
                    ?>
                    <td>
                  ...
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    INNER JOIN programs ON programs.program_id = program_schedule.program_id
                                    WHERE  day = 'Friday' AND programs.branch = '$branch' ORDER BY start_time ASC";
                      $mon1result = mysqli_query($dbcon, $mon1query);
                      while ($mon1row = mysqli_fetch_array($mon1result)) {
                    ?>
                    <td>
                  ...
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    INNER JOIN programs ON programs.program_id = program_schedule.program_id
                                    WHERE  day = 'Saturday' AND programs.branch = '$branch' ORDER BY start_time ASC";
                      $mon1result = mysqli_query($dbcon, $mon1query);
                      while ($mon1row = mysqli_fetch_array($mon1result)) {
                    ?>
                    <td>
                  ...
                  <tr>
                    ...
                    <?php
                      $mon1query = "SELECT *,program_schedule.program_id AS prog_id FROM program_schedule
                                    INNER JOIN programs ON programs.program_id = program_schedule.program_id
                                    WHERE  day = 'Sunday' AND programs.branch = '$branch' ORDER BY start_time ASC";
                      $mon1result = mysqli_query($dbcon, $mon1query);
                      while ($mon1row = mysqli_fetch_array($mon1result)) {
                    ?>
                    <td>
