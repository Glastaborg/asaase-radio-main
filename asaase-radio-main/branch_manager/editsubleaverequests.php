            ...
            <div class="column is-full">
              ...
              <form class="columns is-multiline" action="editsubleaverequests.php?leave_id=<?php echo $leave_id; ?>" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  ...
                  <div class="field">
                    <label class="label">Date Requested: Leave From <span class="has-text-danger">*</span></label>
                    <div class="control">
                      <input class="input" name="date_from" type="date" value="<?php echo $data['date_from']; ?>" >
                    </div>
                  </div>
                  <div class="field">
                    <label class="label">Date Requested: Leave To <span class="has-text-danger">*</span></label>
                    <div class="control">
                    ...
                    <div class="control " >
                      <div class=" ">
                        <select name="leave_status" class="input" required>
                          <option value="" disabled>--select--</option>
                          <option <?php if($data['leave_status'] == "Pending" ){ echo 'selected';} ?> >Pending</option>
                          <option <?php if($data['leave_status'] == "Granted" ){ echo 'selected';} ?> >Granted</option>
                          <option <?php if($data['leave_status'] == "Rejected" ){ echo 'selected';} ?>>Rejected</option>
                        </select>
                      </div>
                    </div>
                  </div>
