      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li><a href="perf-mgn.php"> &nbsp; Performace Review</a></li>
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          ...
          <div class="column is-full">
            <div class="columns">
              ...
              <div class="column is-half">
                  <p class="has-text-right"><a href="perf-mgn.php" class="button is-info" name="button" id="addbtn">Exit</a></p>
              </div>
            </div>
          </div>
          ...
          <div class="column is-full">
            ...
            <div class="columns">
              ...
              ?>
              <div class="column is-half">
                <b>NAME OF THE APPRAISER: </b> <?php echo $suprow['firstname']; ?> <?php echo $suprow['lastname']; ?>
              </div>
            </div>
          </div>
          ...
          <?php include('includes/part-d-mform.php');?>
