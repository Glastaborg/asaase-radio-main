    ...
    <div class="columns">
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          <?php
            $dataquery = "SELECT * FROM activities WHERE activity_id ='$sess_activity_id'";
                    ...
                    <div class="control">
                      ...
                      <datalist name="employee_id" id="employeelist">
                        ...
                        <option value="<?php echo $row['employee_id']; ?>">
                          <?php echo $row['firstname']; ?> <?php echo $row['lastname']; ?> - <?php echo $row['job_description']; ?> <?php echo $row['department']; ?>
                        </option>
                        <?php } ?>
                      </datalist>
                    </div>
