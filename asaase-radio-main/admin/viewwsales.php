...
if(isset($_GET['week_sales_id'])){
  ...
  $query = "SELECT * FROM week_sales
            WHERE week_sales.week_sales_id = '$week_sales_id'";
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li><a href="wsalesreports.php" aria-current="page">Sales Reports</a></li>
            ...
            <div class="columns">
              <div class="column is-half">
                <p class="has-text-left">
                  <a href="editsalesweek.php?week_sales_id=<?php echo $row['week_sales_id']; ?>" class="button is-info mb-2">Edit Weekly Sales Details</a>
                </p>
              </div>
              <div class="column is-half">
          ...
          <div class="column is-full" id="report">
            <div class="columns is-multiline">
              <div class="column is-full">
                ...
                <h2 class="title is-size-4 has-text-centered">WEEKLY SALES DETAILS</h2>
              ...
              <div class="column is-full is-align-items-center">
                <div class="table-container">
                  <table class="table is-fullwidth is-striped is-bordered is-narrow is-hoverable" id="table">
                    <thead>
                      <tr>
                        <th class="is-size-6 is-size-7-mobile">Sales Target For The Week (GHS)</th>
                        <th class="is-size-6 is-size-7-mobile">Actual Sales For The Week (GHS)</th>
                        <th class="is-size-6 is-size-7-mobile">Reasons for Difference</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td class="is-size-6 is-size-7-mobile pb-5"><?php echo $row['sales_target']; ?></td>
                        <td class="is-size-6 is-size-7-mobile pb-5"><?php echo $row['act_sale_target']; ?></td>
                        <td class="is-size-6 is-size-7-mobile pb-5"><?php echo $row['reason']; ?></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
