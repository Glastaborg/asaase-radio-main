...
include('assets/restore.php');
  ...
  $query = "SELECT employee.* FROM employee
            WHERE employee.branch = '$sessbranch'
            AND archive_emp = 'Yes'
          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1">
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Archived Employees</h1>
              </div>
              <div class="column">
                <div class="field">
            ...
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="employees.php" class="button is-white" type="button" name="button" id="addbtn">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-success m-1" title="restore book"  href="archiveemp.php?employee_id=<?php echo $row['employee_id']; ?>">
