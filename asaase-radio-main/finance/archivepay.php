          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" >
              <div class="column is-halfs">
                <h1 class="title is-size-5">Archived Payables Reports</h1>
              </div>
            </div>
          </div>
            ...
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="payable.php" class="button is-white" type="button" name="button" id="addbtn">
                    <i class="fas fa-money-bill-wave"></i>&nbsp; View All Payables
                  </a>
                </p>
              </div>
            </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-success m-1" title="restore week recievable"  href="archivepay.php?pay_rec_id=<?php echo $row['pay_rec_id']; ?>">
