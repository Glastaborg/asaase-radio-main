      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">Part C</a></li>
          </ul>
        </nav>
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          ...
          <?php if (mysqli_num_rows($result) <= 0) {include('includes/part-c-form.php'); ?> 
          ...
          <div class="column is-full is-align-items-center">
            <div class="table-container">
              <table class="table is-fullwidth is-striped is-narrow is-hoverable" id="table">
                ...
                <thead>
                  <tr >
                    <th class="is-size-6 is-size-7-mobile">Summary of Identified Gap(s) (Technical and/or Behavioural):</th>
                    <th class="is-size-6 is-size-7-mobile">Development Support Needed: (Please indicate how support will be provided)</th>
                ...
                <tbody>
                  <tr class="datatr">
                    <td class="is-size-6 is-size-7-mobile"><?php echo $row['sum_of_id']; ?></td>
                    <td class="is-size-6 is-size-7-mobile"><?php echo $row['dev_sup_need']; ?></td>
                    <td class="is-size-6 is-size-7-mobile has-text-right pr-6">
                      <?php //if ($row['leave_status'] !== 'Granted' AND $row['leave_status'] !== 'Rejected') {

                     ?>
                      <a class="button is-size-7 is-info m-1" title="update"  href="editpart-c.php?part_c_id=<?php echo $row['part_c_id']; ?>">
                        <i class="fas fa-edit"></i>
                      </a>
                      <a class="button is-size-7 is-danger m-1" title="delete"  href="assets/part-c-back.php?del_part_c_id=<?php echo $row['part_c_id']; ?>">
                  ...
                  <?php } } else {
                    echo '<tr><td><p class="subtitle is-size-6 p-3 has-text-danger has-background-light">You have no data on Developmental Needs Identification</p></td></tr>';
                  }?>
                </tbody>
              </table>
            </div>
