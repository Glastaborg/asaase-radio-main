      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            <div class="column is-full" style="border-bottom: 1px solid #c7c7c7;">
              <h1 class="title is-size-5">Edit Leave</h1>
            </div>
            ...
            <div class="column is-full">
              ...
              <form class="columns is-multiline" action="editevent.php?event_id=<?php echo $event_id; ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="field">
                    ...
                    <div class="control">
                      <input class="input" id="event_date" name="event_date" min="<?php echo date("Y-m-d"); ?>"  value="<?php echo $data['date']?>" type="date" >
                    </div>
                </div>
               <div class="field">
                  <label for="" class="label">Event Budget (GH₵)<span class="has-text-danger " >*</span></label>
                  <div class="control">
                      <input type="number" class="input" name="event_budget" value="<?php echo $data['budget']?>">
                  </div>
               </div>
               <div class="field">
                  <label for="" class="label">Activity Brief<span class="has-text-danger " >*</span></label>
                  <div class="control">
                      <input type="text" class="input" name="activity_brief" value="<?php echo $data['activity_brief']?>">
