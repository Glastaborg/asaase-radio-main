              ...
              <form class="columns is-multiline" action="addprogram.php" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <input class="input" name="cohost" type="text" placeholder="Co-Host Name" >
                    </div>
                  </div>
                  <div class="field">
                    ...
                    <div class="control">
                      ...
                      <datalist name="producer" id="employeelist">
                        ...
                        $query = "SELECT employee.* FROM employee
                                  WHERE job_description ='Producer'
                                  AND archive_emp = 'No'";
                        $result = mysqli_query($dbcon, $query);
                        while($row = mysqli_fetch_array($result)){
                        ?>
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <textarea class="textarea" name="producers" type="text" placeholder="Producers" ></textarea>
                   ...
                   <div class="field">
                    ...
                    <div class="control">
                      <input type="text" class="input" name="dj" placeholder="Enter or Select DJ" list="djlist" required>
                   ...
                   <div class="field">
                    ...
                    <div class="control">
                      <textarea class="textarea" name="program_desc" type="text" placeholder="Program Description" required></textarea>
                    </div>
                  </div>
                  <div class="field">
