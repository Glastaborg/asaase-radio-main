              ...
              <form class="columns is-multiline" action="addsalesyet.php" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  ...
                  <div class="field">
                    ...
                    <div class="control">
                      <input class="input" name="sales_target_yet" type="number" step="0.01" placeholder="Enter Sales Target Yet to Date" required>
                    </div>
                  </div>
                  <div class="field">
                    <label class="label">Sales to Date <span class="has-text-danger">*</span></label>
                    <div class="control">
                      <input class="input" name="sales_to_date" type="number" step="0.01" placeholder="Enter Sales to Date" required>
                    </div>
                  </div>
                  <div class="field">
