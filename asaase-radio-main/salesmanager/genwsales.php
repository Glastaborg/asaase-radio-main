    ...
    <div class="columns">
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          ...
          <form class="column is-half" action="genwsales.php" method="post">
            <h1 class="title is-size-5">Generate Weekly Sales Report</h1>
            <div class="field">
            ...
            <div class="field is-grouped my-5">
              ...
              <p class="control">
                <button class="button is-info" name="genwsales">
                  &nbsp; Generate &nbsp;
                </button>
              </p>
            </div>
