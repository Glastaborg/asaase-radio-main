...
include('assets/restore.php');
  $query = "SELECT *, assets.branch AS assbranch FROM asset_employee
            ...
            AND archive_asset_employee = 'Yes'";
          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" >
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Archived Assets Assignings</h1>
              </div>
              <div class="column">
                <div class="field">
            ...
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="assetemployee.php" class="button is-white" type="button" name="button" id="addbtn">
                    <i class="fas fa-user-cog"></i>&nbsp; View All Assets Assignings
                  </a>
                </p>
              </div>
            </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-success m-1" title="restore asset employee"  href="archiveassetsemp.php?asset_employee_id=<?php echo $row['asset_employee_id']; ?>">
