            ...
            <div class="columns is-align-items-center py-3" >
              <div class="">
                <p class="panel-tabs">
                  ...
                  &nbsp;&nbsp;
                  <a class="is-active">Accra Weekly Reports</a>
                  &nbsp;&nbsp;
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      ...
                      <a class="button is-size-7 is-danger m-1" title="delete employeesreports"  href="accraempreports.php?employee_report_id=<?php echo $row['employee_report_id']; ?>">
          ...
          <div class="column is-full">
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='accraempreports.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='accraempreports.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href='accraempreports.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
