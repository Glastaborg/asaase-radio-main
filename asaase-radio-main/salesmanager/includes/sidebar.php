<div class="menu px-4 is-2 pb-6 has-background-brown  active" id="aside">
 ...
 <aside class="px-2 mt-5">
    ...
    <ul class="menu-list">
      ...
      <li>
        <a href="subleavereq.php" class="has-icons-left has-text-white">
          <span class="icon is-small is-left">
            <i class="fas fa-tasks"></i>
          </span>
    ...
    <ul class="menu-list">
      ...
      <!-- <li>
        <a href="collections.php" class="has-icons-left has-text-white">
          <span class="icon is-small is-left">
            <i class="fas fa-hand-holding-usd"></i>
          </span>
        Collections
       ...
       <li>
        <a href="pipeline.php" class="has-icons-left has-text-white">
          <span class="icon is-small is-left">
            <i class="fas fa-tasks"></i>
          </span>
