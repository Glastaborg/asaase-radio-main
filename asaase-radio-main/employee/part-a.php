...
if (isset($_GET['perf_part_a_id'])) {
  $_SESSION['perf_id'] = $_GET['perf_part_a_id'];
}
elseif (isset($_POST['perf_part_a_id'])){
  $_SESSION['perf_id'] = $_POST['perf_id'];
}else{
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">Part A</a></li>
          </ul>
        </nav>
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
          ...
          <div class="column is-full">
            <div class="columns">
              <div class="column is-half">
                <a href="perf-review.php" class="button is-info" name="button" id="addbtn">Back</a>
              </div>
              <div class="column is-half">
                <?php if (mysqli_num_rows($result) > 0) { ?>
                  <p class="has-text-right"><a href="part-b.php?perf_part_b_id=<?php echo $_SESSION['perf_id']; ?>" class="button is-info" name="button" id="addbtn">Next Step</a></p>
                <?php }?>
              </div>
            </div>
          </div>
          ...
          <?php include('includes/part-a-form.php');?>
              ...
              <table class="table is-fullwidth is-striped is-narrow is-hoverable" id="table">
                ...
                <thead>
                  <tr >
                    ...
                    <th class="is-size-6 is-size-7-mobile">Key Results Area</th>
                    <th class="is-size-6 is-size-7-mobile">Target (Description)</th>
                    <th class="is-size-6 is-size-7-mobile">Outcome of Target Description(Mid-year OR End of year review – please indicate as appropriate)</th>
                    <th class="is-size-6 is-size-7-mobile">Rating</th>
                    <th class="is-size-6 is-size-7-mobile">Actual Score (one can score more than 100% on a goal)</th>
                ...
                <tbody>
                  <tr class="datatr" >
                    ...
                    ?>
                      <a class="button is-size-7 is-info m-1" title="update"  href="editpart-a.php?part_a_id=<?php echo $row['part_a_id']; ?>">
                        <i class="fas fa-edit"></i>
                      </a> 
                    <?php } ?>
                      <a class="button is-size-7 is-danger m-1" title="delete"  href="assets/part-a-back.php?del_part_a_id=<?php echo $row['part_a_id']; ?>">
                        <i class="fas fa-trash-alt"></i>
                      </a>
                    </td>
                  </tr>
                  <?php } } else {
                    echo '<tr><td><p class="subtitle is-size-6 py-3 has-text-danger">There is no data on Mid or Annual Goals/Targets</p></td></tr>';
                  }?>
                </tbody>
              </table>
            </div>
