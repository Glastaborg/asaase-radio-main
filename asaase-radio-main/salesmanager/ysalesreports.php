        ...
        <div class="column is-full">
          <div class="columns is-align-items-center py-1">
            <div class="column is-half">
              <h1 class="title is-size-5">Year to Date Sales Reports</h1>
            </div>
            <div class="column is-half">
              <form class="" action="" method="post" enctype="multipart/form-data">
                <div class="field is-grouped my-5">
                  ...
                  <div class="control">
                    <button class="button is-info" type="submit" name="import_yet_sales">
                      &nbsp; Import &nbsp;
                    </button>
                  </div>
                </div>
            ...
            <table class="table is-fullwidth is-striped is-narrow is-hoverable" id="table">
              <thead>
                <tr>
                  ...
                  <th class="is-size-6 is-size-7-mobile">Reasons</th>
                  <th class="is-size-6 is-size-7-mobile">Branch</th>
                  <th class="is-size-6 is-size-7-mobile">GM Comment</th>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    <td class="is-size-6 is-size-7-mobile"><?php echo $row['yet_sales_id']; ?></td>
                    ...
                    <td class="is-size-6 is-size-7-mobile"><?php echo $row['gmcomment']; ?></td>
                    <td class="is-size-6 is-size-7-mobile">
                      <?php
                      // Assuming filename is a field in your yet_sales table
                      if (!empty($row['filename'])) {
                      ?>
                        <a href="../files/yearly_sales/<?php echo $row['filename']; ?>" download><?php echo $row['filename']; ?></a>
                      <?php } else {
