          ...
          <div class="column is-full">
            <nav class="pagination is-small" role="navigation" aria-label="pagination">
              ...
              <?php
                ...
                if($page>1){
                  echo "<a class='pagination-previous has-background-white' href='assets.php?page=".($page-1)."'> Previous</a>";
                }

                for($i=1;$i<$total_pages;$i++){
                  echo "<a class='pagination-link has-background-white' href='assets.php?page=".$i."'>$i</a>";
                }

                if($i>$page){
                  echo "<a class='pagination-next has-background-white' href=assets.php?page=".($page+1)."'>Next Page</a>";
                }
              ?>
            </ul>
            </nav>
