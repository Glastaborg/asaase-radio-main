          ...
          <div class="column is-full">
            <div class="columns is-align-items-center py-1" style="border-bottom: 1px solid #c7c7c7;">
              <div class="column is-two-thirds">
                <h1 class="title is-size-5">Archived Employees Reports</h1>
              </div>
              <div class="column">
                <div class="field">
            ...
            <div class="columns">
              ...
              <div class="column is-half">
                <p class="has-text-right">
                  <a href="employeesreports.php" class="button is-white" type="button" name="button" id="addbtn">
                    <i class="far fa-file-alt"></i>&nbsp; View All Employees Reports
                  </a>
                </p>
              </div>
            </div>
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="is-size-6 is-size-7-mobile">
                      <a class="button is-size-7 is-success m-1" title="restore employeesreports"  href="archiveempr.php?employee_report_id=<?php echo $row['employee_report_id']; ?>">
