...
if(isset($_GET['week_col_id'])){
  ...
  $query = "SELECT * FROM week_collection
            WHERE week_collection.week_col_id = '$week_col_id'";
      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <nav class="breadcrumb p-3" aria-label="breadcrumbs">
          <ul>
            ...
            <li class="is-active"><a href="#" aria-current="page">View Weekly Collection Reports</a></li>
          </ul>
        </nav>
            ...
            <div class="columns">
              <div class="column is-half">
                <p class="has-text-left">
                  <a href="editcolweek.php?week_col_id=<?php echo $row['week_col_id']; ?>" class="button is-info mb-2">Edit Weekly Collection Details</a>
                </p>
              </div>
              <div class="column is-half">
          ...
          <div class="column is-full" id="report">
            <div class="columns is-multiline">
              <div class="column is-full">
                ...
                <h2 class="title is-size-4 has-text-centered">WEEKLY COLLECTION DETAILS</h2>
              ...
              <div class="column is-full is-align-items-center">
                <div class="table-container">
                  <table class="table is-fullwidth is-striped is-bordered is-narrow is-hoverable" id="table">
                    <thead>
                      <tr>
                        <th class="is-size-6 is-size-7-mobile">Weekly Collection (GHS)</th>
                        <th class="is-size-6 is-size-7-mobile">Annual Budget Collection (GHS)</th>
                        <th class="is-size-6 is-size-7-mobile">Reasons for Difference</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td class="is-size-6 is-size-7-mobile pb-5"><?php echo $row['col_week_amt']; ?></td>
                        <td class="is-size-6 is-size-7-mobile pb-5"><?php echo $row['col_budget_amt']; ?></td>
