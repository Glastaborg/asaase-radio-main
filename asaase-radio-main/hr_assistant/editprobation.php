      ...
      <div class="column is-10 has-background-light" id="main">
        ...
        <div class="columns is-multiline has-background-white mx-1 mb-3 p-3">
            ...
            <?php
              ...
              $dataquery = "SELECT * FROM probation WHERE probation_id ='$probation_id'";
              ...
              <form class="columns is-multiline" action="" method="post" enctype="multipart/form-data">
                <div class="column is-half">
                  <div class="field" hidden>
                    ...
                    <div class="control">
                      <input type="text" class="input" name="probation_id" value="<?php echo $data['probation_id']; ?>" readonly >
                      <input type="text" class="input" name="o_filename" value="<?php echo $data['filename']; ?>" readonly >
                    </div>
                  </div>
                  <div class="field">
                    <label class="label"> Upload your file <span class="has-text-danger">*</span></label>
                    <div class="control">
                      <input type="file" class="input" name="filename" value="../file/<?php echo $data['filename']; ?>" required >
                    </div>
                  </div>
                  ...
                  <div class="field is-grouped my-5">
                    ...
                    <p class="control">
                      <button class="button is-info" name="update_probation">
                        &nbsp; Update &nbsp;
                      </button>
                    </p>
                  </div>
